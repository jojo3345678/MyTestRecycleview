...
public class FragmentFriendsBindingImpl extends FragmentFriendsBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.example.recycleviewtest.FriendsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.example.recycleviewtest.FriendsViewModel ViewModel) {
